...
import { SmartphoneRecommendationCard, SmartphoneSignalBreakdownItem } from "@/lib/types";
...
function SignalRow({ item }: { item: SmartphoneSignalBreakdownItem }) {
...
export default function SmartphoneCard({ card, index }: Props) {
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            {device.cpu} · {device.display_size}&quot; · {device.weight_g}g
          </p>
        </div>
        ...
        >
          <div>
            ...
            {recommended_sku && (
              ...
              >
                {recommended_sku.storage_gb >= 1000
                  ? `${recommended_sku.storage_gb / 1000}TB`
                  : `${recommended_sku.storage_gb}GB`}
                {recommended_sku.color ? ` · ${recommended_sku.color}` : ""}
              </span>
            )}
          </div>
